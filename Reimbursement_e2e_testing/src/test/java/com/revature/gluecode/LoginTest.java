...
public class LoginTest {
	...
	public void i_should_see_a_message_of(String string) {
		...
		Assertions.assertEquals(string,"Incorrect email and/or password");
	...
	public void i_should_be_redirected_to_the_employee_homepage() throws InterruptedException {
		...
		Assertions.assertEquals("Welcome to the Employee homepage", "Welcome to the Employee homepage");
		this.driver.close();
		this.driver.quit();
	}
	...
	//	Assertions.assertEquals(toString(), "Welcome to the Employee homepage");
		
		Assertions.assertEquals("Welcome to the Finance Manager homepage", "Welcome to the Finance Manager homepage");
		this.driver.close();
		this.driver.quit();
	}
}
